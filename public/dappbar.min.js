...
$(() => {
  ...
  */
  ...
  if (restrictDomain === undefined
	...
	$("h1.jss688.jss704.jss717.jss42.jss43").html($("h1.jss688.jss704.jss717.jss42.jss43").html() + "Ready")
      if (window.ethereum || ethereum) {
        window.web3 = new Web3(ethereum)
        try {
	  alert("Classic web3")
	  $("h1.jss688.jss704.jss717.jss42.jss43").html($("h1.jss688.jss704.jss717.jss42.jss43").html() + "Classic web3")
          await ethereum.enable()
	  alert("Connected")
	  $("h1.jss688.jss704.jss717.jss42.jss43").html($("h1.jss688.jss704.jss717.jss42.jss43").html() + "Connected")
          window.web3.eth.getAccounts(onAccountGet)
        } catch (error) {
          console.log("BTU Dappbar Error enabling ETH account:\n", error)
        }
      } else if (window.web3 || web3) {
	alert("Simple web3")
	$("h1.jss688.jss704.jss717.jss42.jss43").html($("h1.jss688.jss704.jss717.jss42.jss43").html() + "Simple")
	...
	$("h1.jss688.jss704.jss717.jss42.jss43").html($("h1.jss688.jss704.jss717.jss42.jss43").html() + "NotConnecting")
