...
// Recupérer le navigateur
var sUsrAg = navigator.userAgent;

// Mettre le nom et le logo du provider du wallet, par example BTU direct
...
const modalDoneContent = () => {return {
  top: `
	...
	bottom: `
    <div id="btu-modal-content-inner">
      <div id="btu-address-txt-title">${t("isConnected.BTUAddr")}</div>
...
#btu-address-txt {margin: 0; color: #6e6e6e; font-size: 15px; text-align: center; padding-bottom: 20px;}
